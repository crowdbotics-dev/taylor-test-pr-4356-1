"""
Django settings for taylor_test_pr_4356_1 project.
...
ROOT_URLCONF = 'taylor_test_pr_4356_1.urls'
...
WSGI_APPLICATION = 'taylor_test_pr_4356_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "taylor_test_pr_4356_1 API",
    "DESCRIPTION": "API documentation for taylor_test_pr_4356_1 App",
    "VERSION": "v1",
}
